          ...
          >
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none">
              <li className="items-center">
                <Link href="/Linkdmin/dashboard">
                  <Link
                    href="#pablo"
                    className={
                      "text-xs uppercase py-3 font-bold block " +
                      (router.pathname.indexOf("/Linkdmin/dashboard") !== -1
              ...
              <li className="items-center">
                <Link href="/Linkdmin/settings">
                  <Link
                    href="#pablo"
                    className={
                      "text-xs uppercase py-3 font-bold block " +
                      (router.pathname.indexOf("/Linkdmin/settings") !== -1
                        ? "text-lightBlue-500 hover:text-lightBlue-600"
                        : "text-blueGray-700 hover:text-blueGray-500")
                    }
                  >
              ...
              <li className="items-center">
                <Link href="/Linkdmin/tables">
                  <Link
                    href="#pablo"
                    className={
                      "text-xs uppercase py-3 font-bold block " +
                      (router.pathname.indexOf("/Linkdmin/tables") !== -1
                        ? "text-lightBlue-500 hover:text-lightBlue-600"
                        : "text-blueGray-700 hover:text-blueGray-500")
                    }
                  >
              ...
              <li className="items-center">
                <Link href="/Linkdmin/maps">
                  <Link
                    href="#pablo"
                    className={
                      "text-xs uppercase py-3 font-bold block " +
                      (router.pathname.indexOf("/Linkdmin/maps") !== -1
                        ? "text-lightBlue-500 hover:text-lightBlue-600"
                        : "text-blueGray-700 hover:text-blueGray-500")
                    }
                  >
            ...
            <ul className="md:flex-col md:min-w-full flex flex-col list-none md:mb-4">
              ...
              <li className="inline-flex">
                <Link
                  href="https://www.creative-tim.com/learning-lab/tailwind/nextjs/Linklerts/notus"
                  target="_blank"
                  className="text-blueGray-700 hover:text-blueGray-500 text-sm block mb-4 no-underline font-semibold"
                >
              ...
              <li className="inline-flex">
                <Link
                  href="https://www.creative-tim.com/learning-lab/tailwind/Linkngular/overview/notus"
                  target="_blank"
                  className="text-blueGray-700 hover:text-blueGray-500 text-sm block mb-4 no-underline font-semibold"
                >
